...
document.querySelectorAll("button")[1].addEventListener("click", handCli1);
function handCli1() {
...
document.querySelectorAll("button")[2].addEventListener("click", handCli2);
function handCli2() {
...
document.querySelectorAll("button")[3].addEventListener("click", handCli3);
function handCli3() {
...
document.querySelectorAll("button")[4].addEventListener("click", handCli4);
function handCli4() {
...
document.querySelectorAll("button")[5].addEventListener("click", handCli5);
function handCli5() {
...
document.querySelectorAll("button")[6].addEventListener("click", handCli6);
function handCli6() {
...
document.querySelectorAll("button")[7].addEventListener("click", handCli7);
function handCli7() {
...
document.querySelectorAll("button")[8].addEventListener("click", handCli8);
function handCli8() {
...
document.querySelectorAll("button")[9].addEventListener("click", handCli9);
function handCli9() {
...
document.querySelectorAll("button")[10].addEventListener("click", handCli10);
function handCli10() {
...
document.querySelectorAll("button")[11].addEventListener("click", handCli11);
function handCli11() {
...
document.querySelectorAll("button")[12].addEventListener("click", handCli12);
function handCli12() {
...
document.querySelectorAll("button")[13].addEventListener("click", handCli13);
function handCli13() {
...
document.querySelectorAll("button")[14].addEventListener("click", handCli14);
function handCli14() {
...
document.querySelectorAll("button")[15].addEventListener("click", handCli15);
function handCli15() {
...
document.querySelectorAll("button")[16].addEventListener("click", handCli16);
function handCli16() {
